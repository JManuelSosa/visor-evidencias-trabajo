...
import { useDirectUpload } from "@/composables/files/useDirectUpload";
...
export class FileUploader {
     ...
     * @param uploadId - Id de subida para rastrear la subida
     ...
     */
    async upload(file:File, context:ContextType, uploadId:string, callbacks:UploadCallbacks = {}):Promise<number> {
        ...
        // Subir a R2
        await this.directUploadService.uploadToR2(file, upload_url, headers, uploadId, callbacks.onProgress);
